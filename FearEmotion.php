...
<body>
    ...
    $sql = "SELECT * FROM data where Mood = 'stressed helpless' or Mood = 'worried stressed' or Mood = 'crying discouraged fear' or Mood = 'bored stressed fear' or Mood = 'stressed bored' or Mood = 'sad stressed' or Mood = 'stressed discouraged'";
